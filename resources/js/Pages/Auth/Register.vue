            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <div>
                    ...
                    <p class="mt-2 text-center text-sm text-gray-600">
                        O
                        <a :href="route('login')" class="font-medium text-emerald-500 hover:text-emerald-600">
                ...
                <form class="mt-8 space-y-6" @submit.prevent="submit">
                    <div v-if="form.errors.email || form.errors.name" class="rounded-md bg-red-50 p-4">
                        <p class="text-sm text-red-800">{{ form.errors.email || form.errors.name }}</p>
                    </div>
