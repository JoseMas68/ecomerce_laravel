...
final class StoreCategoryRequest extends FormRequest
{
    ...
    protected function withValidator(Validator $validator): void
    {
        $validator->after(function ($validator) {
            ...
            // Validar que parent_id no sea el mismo ID de la categoría que se está creando
            // Esto es útil en actualizaciones, pero prevenimos el error en creación también
            if ($parentId !== null && is_numeric($parentId)) {
                // En creación, no hay un ID aún, así que esta validación es más relevante en actualización
                // Pero incluimos la lógica por consistencia
